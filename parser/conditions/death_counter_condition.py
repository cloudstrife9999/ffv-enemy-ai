...
class DeathCounterCondition(AIRuleCondition):
    def __init__(self, second_byte: int, third_byte: int, fourth_byte: int) -> None:
        super().__init__(ConditionCode.DEATH_COUNTER.value, second_byte, third_byte, fourth_byte)
    ...
    def to_compact_representation(self, indent: int) -> list[str]:
        return [f"{" " * indent}Just before dying"]
