...
class HitByElementalCommandCondition(AIRuleCondition):
    def __init__(self, match_type: MatchType, command: Command, elemental_mask: int) -> None:
        super().__init__(ConditionCode.HIT_BY_COMMAND_WITH_ELEMENT.value, match_type.value, command.value, elemental_mask)
