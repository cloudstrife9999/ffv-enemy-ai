...
class NoFemalePartyMembersTargetableCondition(AIRuleCondition):
    def __init__(self, second_byte: int, third_byte: int, fourth_byte: int) -> None:
        super().__init__(ConditionCode.NO_FEMALE_PARTY_MEMBERS_TARGETABLE.value, second_byte, third_byte, fourth_byte)
