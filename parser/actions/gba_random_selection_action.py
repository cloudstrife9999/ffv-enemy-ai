...
class GBARandomSelectionAction(AIRuleAction):
    ...
    def to_compact_representation(self, indent: int) -> list[str]:
        first_choice_repr: str = GBARandomSelectionAction.__format_choice_repr(self.first_choice.to_compact_representation(0)[0])
        second_choice_repr: str = GBARandomSelectionAction.__format_choice_repr(self.second_choice.to_compact_representation(0)[0])
        third_choice_repr: str = GBARandomSelectionAction.__format_choice_repr(self.third_choice.to_compact_representation(0)[0])
